...
class Bot:
    def __init__(self, network, serverport, nickname, realname):
        ...
        #self.modules = ["standard", "help", "link", "dictionary", "autoop", "google", "mui"]
    ...
    def reload(self):
        ...
        for module in self.modules:
            ...
            print str(i)+' '+str(sys.modules["modules."+module])
            i += 1
    ...
    def recv(self):
        ...
        try:
            color.printcolor(time.strftime("[%T]")+' -> '+data)
        except:
            traceback.print_exc()
    ...
    # PRIVMSG
    def message(self, to, msg, maxlines=0):
        i = 1
